...
val stg1 = [
    ...
    new lootEntry(<item:tfc:straw>, 4, 3, 4),
    ...
    new lootEntry(<item:minecraft:paper>, 3, 1, 9),
    new lootEntry(<item:minecraft:brick>, 3, 1, 5),
    new lootEntry(<item:tfc:rock/loose/claystone>, 3, 1, 4),
    ...
    new lootEntry(<item:tfc:metal/ingot/copper>, 2, 1, 1),
    new lootEntry(<item:tfc:metal/ingot/bronze>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/silver>, 2, 1, 1),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 2, 1, 1),
...
val stg2 = [
    ...
    new lootEntry(<item:tfc:metal/ingot/copper>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/bronze>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/silver>, 2, 1, 1),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 2, 1, 1),
    new lootEntry(<item:tfc:metal/ingot/gold>, 2, 1, 1),
    new lootEntry(<item:tfc:metal/ingot/rose_gold>, 2, 1, 1),
...
val stg3 = [
    new lootEntry(<item:tfc:dead_torch>, 4, 1, 6),
    ...
    new lootEntry(<item:tfc:metal/ingot/zinc>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/nickel>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/tin>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/copper>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/bronze>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/pig_iron>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/silver>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 2, 1, 1),
    new lootEntry(<item:tfc:metal/ingot/gold>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/rose_gold>, 2, 1, 1),
    new lootEntry(<item:minecraft:arrow>, 2, 2, 4),
...
val stg4 = [
    ...
    new lootEntry(<item:minecraft:bone>, 3, 2, 3),
    new lootEntry(<item:tfc:plant/liana>, 3, 1, 4),
    new lootEntry(<item:minecraft:coal>, 3, 2, 7),
    new lootEntry(<item:minecraft:cobweb>, 2, 1, 2),
    new lootEntry(<item:tfc:wood/fallen_leaves/kapok>, 2, 1, 2),
    new lootEntry(<item:minecraft:arrow>, 2, 2, 4),
    new lootEntry(<item:minecraft:stick>, 2, 1, 6),
    ...
    new lootEntry(<item:tfc:metal/ingot/zinc>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/nickel>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/tin>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/bismuth>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/copper>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/bronze>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/wrought_iron>, 2, 2, 4),
    new lootEntry(<item:tfc:metal/ingot/cast_iron>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/pig_iron>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/silver>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/gold>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/rose_gold>, 2, 1, 2),
    new lootEntry(<item:tfc:ceramic/jug>.withTag({
        fluid: {Amount: 100 as int, 
        FluidName: "minecraft:water" as string}}), 1, 2, 2),
...
val stg5 = [
    ...
    new lootEntry(<item:tfc:dead_torch>, 4, 1, 5),
    new lootEntry(<item:minecraft:bone>, 3, 2, 3),
    new lootEntry(<item:minecraft:fire_charge>, 3, 1, 3),
    new lootEntry(<item:minecraft:cobweb>, 2, 1, 2),
    new lootEntry(<item:minecraft:arrow>, 2, 2, 4),
    new lootEntry(<item:tfc:wood/twig/rosewood>, 2, 1, 6),
    new lootEntry(<item:tfc:ore/sulfur>, 2, 1, 4),
    new lootEntry(<item:minecraft:glowstone_dust>, 2, 1, 3),
    new lootEntry(<item:tfc:seeds/onion>, 2, 2, 4),
    ...
    new lootEntry(<item:tfc:metal/ingot/zinc>, 2, 2, 4),
    new lootEntry(<item:tfc:metal/ingot/nickel>, 2, 2, 4),
    new lootEntry(<item:tfc:metal/ingot/tin>, 2, 2, 4),
    new lootEntry(<item:tfc:metal/ingot/bismuth>, 2, 1, 4),
    new lootEntry(<item:tfc:metal/ingot/copper>, 2, 2, 4),
    new lootEntry(<item:tfc:metal/ingot/wrought_iron>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/cast_iron>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/silver>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 2, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/gold>, 2, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/rose_gold>, 2, 1, 2),
    new lootEntry(<item:tfc:ceramic/jug>.withTag({
        fluid: {Amount: 100 as int, 
        FluidName: "minecraft:water" as string}}), 1, 2, 2),
...
val treasure = [
    new lootEntry(<item:firmalife:metal/ingot/chromium>, 1, 1, 1)
] as lootEntry[];
