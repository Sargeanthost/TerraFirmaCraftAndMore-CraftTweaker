...
val stg2and3r = [
    ...
    new lootEntry(<item:tfc:ceramic/jug>.withTag({
        fluid: {Amount: 100 as int, 
        FluidName: "minecraft:water" as string}}), 1, 2, 2),
    new lootEntry(<item:minecraft:lead>, 1, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/zinc>, 1, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/nickel>, 1, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/tin>, 1, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/copper>, 1, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/bronze>, 1, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/pig_iron>, 1, 1, 3),
    new lootEntry(<item:tfc:metal/ingot/silver>, 1, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 1, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/gold>, 1, 1, 2),
    new lootEntry(<item:tfc:metal/ingot/rose_gold>, 1, 1, 2),
...
val stg4and5r = [
    new lootEntry(<item:minecraft:coal>, 2, 4, 9),
    new lootEntry(<item:minecraft:bone>, 2, 2, 3),
    ...
    new lootEntry(<item:tfc:metal/ingot/bismuth>, 1, 2, 3),
    new lootEntry(<item:tfc:metal/ingot/copper>, 1, 2, 3),
    new lootEntry(<item:tfc:metal/ingot/wrought_iron>, 1, 2, 3),
    new lootEntry(<item:tfc:metal/ingot/cast_iron>, 1, 2, 3),
    new lootEntry(<item:tfc:metal/ingot/silver>, 1, 2, 3),
    new lootEntry(<item:tfc:metal/ingot/sterling_silver>, 1, 2, 2),
    new lootEntry(<item:tfc:metal/ingot/gold>, 1, 2, 3),
    new lootEntry(<item:tfc:metal/ingot/rose_gold>, 1, 2, 2),
    new lootEntry(<item:firmalife:metal/ingot/chromium>, 1, 1, 3),
    new lootEntry(<item:tfc_metallum:metal/ingot/pewter>, 1, 1, 3),
    new lootEntry(<item:tfc_metallum:metal/ingot/thorium>, 1, 1, 3),
    new lootEntry(<item:tfc_metallum:metal/ingot/titanium>, 1, 1, 3),
    ...
    new lootEntry(<item:tfc:metal/shield/bismuth_bronze>, 1, 1, 1),
    new lootEntry(<item:tfc:metal/shield/black_bronze>, 1, 1, 1),
    new lootEntry(<item:tfc:ore/graphite>, 1, 1, 3),
    new lootEntry(<item:tfc:ore/kaolinite>, 1, 1, 5),
    new lootEntry(<item:tfc:ore/borax>, 1, 1, 2)
] as lootEntry[];
