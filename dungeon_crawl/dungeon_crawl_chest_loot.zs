...
loot.modifiers.register("stage_1",
    ...
    (drops, context) =>{
        ...
        var arr = [
                new lootEntry(<item:tfc:food/red_apple>, 2, 1, 4),
                new lootEntry(<item:tfc:food/potato>, 2, 1, 4),
                new lootEntry(<item:tfc:food/onion>, 2, 1, 4),
                new lootEntry(<item:tfc:food/carrot>,2, 1, 4),
                new lootEntry(<item:tfc:food/cooked_beef>, 2, 1, 2),
                new lootEntry(<item:minecraft:coal>, 3, 1, 6),
                new lootEntry(<item:tfc:metal/ingot/wrought_iron>, 2, 1, 1),
                new lootEntry(<item:tfc:metal/ingot/gold>, 2, 1, 1),
                new lootEntry(<item:minecraft:arrow>, 2, 1, 3),
                ...
                new lootEntry(<item:minecraft:clay_ball>, 1, 1, 4),
                new lootEntry(<item:minecraft:flint>, 1, 1, 2),
                new lootEntry(<item:tfc:wool_yarn>, 3, 1, 1),
                new lootEntry(<item:minecraft:gunpowder>, 3, 1, 2),
                new lootEntry(<item:minecraft:ink_sac>, 1, 1, 2),
                ...
                new lootEntry(<item:minecraft:egg>, 1, 1, 2),
                new lootEntry(<item:minecraft:paper>, 1, 1, 4),
                new lootEntry(<item:tfc:food/sugarcane>, 1, 1, 4),
                new lootEntry(<item:minecraft:brick>, 3, 1, 3),
                new lootEntry(<item:tfc:metal/ingot/copper>, 1, 1, 1),
                new lootEntry(<item:tfc:metal/ingot/bronze>, 1, 1, 1),
                new lootEntry(<item:tfc:small_raw_hide>, 2, 1, 2),
                ...
                new lootEntry(<item:tfc:food/banana>, 2, 1, 1),
                ...
                new lootEntry(<item:minecraft:book>, 3, 1, 3),
                new lootEntry(<item:tfc:dead_torch>, 6, 1, 4),
                new lootEntry(<item:tfc:food/cheese>, 2, 1, 1),
                new lootEntry(<item:tfc:food/taro_root>, 2, 1, 3),
                new lootEntry(<item:minecraft:bowl>, 3, 1, 3),
